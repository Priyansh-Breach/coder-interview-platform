...
import { BadgeIcon, CodeIcon, ReplyIcon } from "@/components/ui/Icons/SelectMore"
        ...
        <>
            ...
            <div className="flex flex-col min-h-[100dvh]">
                                ...
                                <div className="flex flex-col justify-center space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <p className="max-w-[600px] text-muted-foreground md:text-xl">
                                            Prepare for your coding interview with our AI-powered platform. Get personalized feedback, practice
                                            questions, and expert guidance to land your dream job.
                                        </p>
                                    </div>
                        ...
                        <div className="container px-4 md:px-6">
                            <div className="flex flex-col items-center justify-center space-y-4 text-center">
                                <div className="space-y-2">
                                    ...
                                    <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Elevate Your Coding Interview Prep</h2>
                                    <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                        Our AI-powered platform provides personalized guidance and practice to help you ace your next coding
                                        interview.
                                    </p>
                                </div>
                            </div>
                            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
                                <div className="grid gap-1">
                                    ...
                                    <p className="text-muted-foreground">
                                        Get tailored practice questions based on your skill level and interview needs.
                                    </p>
                                </div>
                                <div className="grid gap-1">
                                    <div className="flex items-center gap-2">
                                    ...
                                    <p className="text-muted-foreground">
                                        Receive real-time feedback on your code and performance to improve quickly.
                                    </p>
                                </div>
                                <div className="grid gap-1">
                                    <div className="flex items-center gap-2">
                                    ...
                                    <p className="text-muted-foreground">
                                        Get personalized advice from experienced interviewers to refine your skills.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="container px-4 md:px-6">
                            <div className="flex flex-col items-center justify-center space-y-4 text-center">
                                <div className="space-y-2">
                                    ...
                                    <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                        Hear from real people who have used our platform to land their dream jobs.
                                    </p>
                                </div>
                                <div className="grid max-w-5xl grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3">
                                    <Card className="flex flex-col gap-4 p-6 bg-background shadow-sm transition-shadow hover:shadow-md">
                                        ...
                                        <blockquote className="flex-1">
                                            <p className="text-muted-foreground">
                                                "The AI-powered practice questions and feedback helped me\n identify and improve my weak areas. I
                        ...
                        <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
                            <div className="space-y-3">
                                ...
                                <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                    Sign up now and start practicing with our AI-powered platform. Get personalized feedback and expert
                ...
                <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
                    <p className="text-xs text-muted-foreground">&copy; 2024 AI Coding Interview. All rights reserved.</p>
